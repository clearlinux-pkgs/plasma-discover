...
Version  : 6.0.2
Release  : 95
URL      : https://download.kde.org/stable/plasma/6.0.2/discover-6.0.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.2/discover-6.0.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.2/discover-6.0.2.tar.xz.sig
...
%prep
%setup -q -n discover-6.0.2
cd %{_builddir}/discover-6.0.2
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710366595
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
