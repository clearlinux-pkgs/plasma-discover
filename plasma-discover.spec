...
Version  : 5.27.8
Release  : 86
URL      : https://download.kde.org/stable/plasma/5.27.8/discover-5.27.8.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.8/discover-5.27.8.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.8/discover-5.27.8.tar.xz.sig
...
%prep
%setup -q -n discover-5.27.8
cd %{_builddir}/discover-5.27.8
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694541115
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
