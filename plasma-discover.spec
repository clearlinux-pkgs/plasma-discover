...
Version  : 6.1.0
Release  : 103
URL      : https://download.kde.org/stable/plasma/6.1.0/discover-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.0/discover-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.0/discover-6.1.0.tar.xz.sig
...
%setup -q -n discover-6.1.0
cd %{_builddir}/discover-6.1.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718909388
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
