...
Version  : 5.27.3
Release  : 80
URL      : https://download.kde.org/stable/plasma/5.27.3/discover-5.27.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.3/discover-5.27.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.3/discover-5.27.3.tar.xz.sig
...
%prep
%setup -q -n discover-5.27.3
cd %{_builddir}/discover-5.27.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679517945
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
