...
Version  : 6.3.3
Release  : 118
URL      : https://download.kde.org/stable/plasma/6.3.3/discover-6.3.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.3/discover-6.3.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.3/discover-6.3.3.tar.xz.sig
...
%setup -q -n discover-6.3.3
cd %{_builddir}/discover-6.3.3
%patch -P 1 -p1
pushd ..
cp -a discover-6.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742483959
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
