...
Version  : 6.0.3
Release  : 98
URL      : https://download.kde.org/stable/plasma/6.0.3/discover-6.0.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.3/discover-6.0.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.3/discover-6.0.3.tar.xz.sig
...
%prep
%setup -q -n discover-6.0.3
cd %{_builddir}/discover-6.0.3
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711648438
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
