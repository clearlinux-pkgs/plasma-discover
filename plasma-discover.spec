...
Source0  : https://download.kde.org/stable/plasma/5.26.1/discover-5.26.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.1/discover-5.26.1.tar.xz.sig
...
%prep
%setup -q -n discover-5.26.1
cd %{_builddir}/discover-5.26.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666280364
mkdir -p clr-build
pushd clr-build
