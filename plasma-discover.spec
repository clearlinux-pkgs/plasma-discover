...
Version  : 5.26.2
Release  : 67
URL      : https://download.kde.org/stable/plasma/5.26.2/discover-5.26.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.26.2/discover-5.26.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.2/discover-5.26.2.tar.xz.sig
...
%prep
%setup -q -n discover-5.26.2
cd %{_builddir}/discover-5.26.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667241593
mkdir -p clr-build
pushd clr-build
