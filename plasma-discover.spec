...
Version  : 6.1.1
Release  : 104
URL      : https://download.kde.org/stable/plasma/6.1.1/discover-6.1.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.1/discover-6.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.1/discover-6.1.1.tar.xz.sig
...
%setup -q -n discover-6.1.1
cd %{_builddir}/discover-6.1.1
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719420813
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
