...
Source0  : https://download.kde.org/stable/plasma/6.0.5/discover-6.0.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.5/discover-6.0.5.tar.xz.sig
...
%setup -q -n discover-6.0.5
cd %{_builddir}/discover-6.0.5
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716391366
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
