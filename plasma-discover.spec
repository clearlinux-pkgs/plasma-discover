...
Version  : 5.27.10.1
Release  : 91
URL      : https://download.kde.org/stable/plasma/5.27.10/discover-5.27.10.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.10/discover-5.27.10.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.10/discover-5.27.10.1.tar.xz.sig
...
%prep
%setup -q -n discover-5.27.10.1
cd %{_builddir}/discover-5.27.10.1
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707750412
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
