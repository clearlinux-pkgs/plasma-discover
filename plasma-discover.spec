...
Version  : 5.27.2
Release  : 79
URL      : https://download.kde.org/stable/plasma/5.27.2/discover-5.27.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.2/discover-5.27.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.2/discover-5.27.2.tar.xz.sig
...
%prep
%setup -q -n discover-5.27.2
cd %{_builddir}/discover-5.27.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677601061
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
