...
Source0  : https://download.kde.org/stable/plasma/6.3.0/discover-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.0/discover-6.3.0.tar.xz.sig
...
%setup -q -n discover-6.3.0
cd %{_builddir}/discover-6.3.0
%patch -P 1 -p1
pushd ..
cp -a discover-6.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739296619
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
