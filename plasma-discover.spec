...
Version  : 5.18.2
Release  : 23
URL      : https://download.kde.org/stable/plasma/5.18.2/discover-5.18.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.18.2/discover-5.18.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.18.2/discover-5.18.2.tar.xz.sig
...
%prep
%setup -q -n discover-5.18.2
cd %{_builddir}/discover-5.18.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582742701
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/discover-5.18.2/COPYING %{buildroot}/usr/share/package-licenses/plasma-discover/65aec5a8ccb6ecc51d700c66d290ce66f0a5e9f7
cp %{_builddir}/discover-5.18.2/COPYING.GFDL %{buildroot}/usr/share/package-licenses/plasma-discover/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
cp %{_builddir}/discover-5.18.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/plasma-discover/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
